				...
				{this.props.failedNotification && (
					<View style={[styles.main_task_done, styles.backgroundColorWhite]}>
						<View style={[styles.main_task_done_content, styles.backgroundColorWhite]}>
							<Text style={[styles.text_big, styles.textBlack]}>{I18n.t('MAIN_TASK_FAILED')}</Text>
							<Text style={[styles.text, styles.textBlack]}>{I18n.t('MAIN_TASK_FAILURE_REASON')}</Text>
							<Button
								transparent
								style={styles.confirm_button}
								onPress={() => {
							...
							>
								<LinearGradient
									...
									style={styles.confirm_button}
								/>
								<Text style={[styles.confirm_button_text, styles.textWhite]}>{I18n.t('OK')}</Text>
							</Button>
						</View>
					</View>
				)}
