		...
		return (
			...
			>
				<FastImage
					...
					source={{
						uri: this.props.item.photo ? this.props.item.photo : ICONS.INSTAGRAM_COLOR,
					}}
				/>
				<View style={styles.social_text_container}>
					<Text style={[styles.social_text, styles.social_text_title]}>{this.props.item.name}</Text>
					...
					<View style={styles.timer_row}>
						...
						<View style={styles.timer_column}>
							<Text style={[styles.social_text, styles.social_text_big]}>:</Text>
							<Text style={[styles.social_text, styles.social_text_ddmmss]}>:</Text>
						</View>
						<View style={styles.timer_column}>
							<Text style={[styles.social_text, styles.social_text_big]}>
