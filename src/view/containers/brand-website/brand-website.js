				...
				{!this.state.infoPage ? (
					<View style={this.props.visible ? styles.main_view : styles.hidden}>
						<WebView
							...
							source={{
								uri: this.props.brand_link ? this.props.brand_link : this.props.game_info.website_link,
							}}
						...
						<View style={styles.timer_header}>
							...
							/>
							<Button rounded block transparent style={styles.button_close} onPress={() => {}}>
								<FastImage
									style={styles.icon}
					...
					<View style={styles.info_page}>
						...
						<Text style={styles.infoPage_title}>
							...
							{this.props.game_info.wait_timer_in_sec < 60
								? // show time in seconds
								  this.props.game_info.wait_timer_in_sec + ' ' + I18n.t('GAME.RESULT.SEC').toUpperCase()
								: // show time in minutes
								  this.props.game_info.wait_timer + ' ' + I18n.t('GAME.RESULT.MIN').toUpperCase()}
						</Text>
						...
						>
							<Text style={[styles.continue_text, { color: this.props.userColor.pink_blue }]}>
