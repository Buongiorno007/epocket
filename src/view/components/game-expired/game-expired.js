...
class GameStart extends React.Component {
	...
	_handleAppStateChange = (nextAppState) => {
		...
		// }
		if ((this.props.appState === 'background' || this.props.appState === 'inactive') && nextAppState === 'active') {
				...
				{this.props.game_expired_img.game_link ? (
					<View style={[styles.main_view_secondary, { paddingBottom: 80 }]}>
						...
						<View style={styles.container_zifi_lock}>
							...
							<Image style={styles.zifi} source={require('../../../assets/img/zifi/grimaces.gif')} />
						</View>
					...
					<View style={styles.main_view_secondary}>
						...
						<View style={styles.container_zifi_lock}>
							...
							<Image style={styles.zifi} source={require('../../../assets/img/zifi/surprised.gif')} />
						</View>
						<GameTimer
