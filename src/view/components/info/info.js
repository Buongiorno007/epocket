      ...
      <View style={styles.main_view}>
        <View style={styles.back_view}>
          <ImageBackground
            ...
            source={require("../../../assets/img/INFO_BACK.jpg")}
          />
        </View>
        ...
        <ScrollView style={styles.scroll}>
          <LinearGradient
            colors={[
              "rgba(171,107,255,0.91)",
              "rgba(254,81,162,0.95)",
              "rgba(253,77,133,0.90)",
              "rgba(252,72,102,0.90)"
            ]}
            start={{ x: 0.0, y: 1.0 }}
            end={{ x: 0.5, y: 0.2 }}
