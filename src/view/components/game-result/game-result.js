...
class GameResult extends React.Component {
    ...
    chooseButtonText = status => {
        ...
        if (status === 'success') {
            ...
            text = I18n.t(
                'GAME.RESULT.PUBLISH_AND_CONTINUE'
            ).toLocaleUpperCase();
        } else {
            text = '';
        }
        ...
        return (
            <View style={styles.container}>
                ...
                <CustomAlert
                    ...
                    subtitle={
                        this.state.userCount + I18n.t('PROFILE_PAGE.SUBS')
                    }
                    first_btn_title={I18n.t('OK')}
                ...
                >
                    ...
                    <Image
                        //resizeMode={FastImage.resizeMode.contain}
                        style={styles.zifi}
                        source={this.chooseZifi(
                            this.props.navigation.state.params.status
                        )}
                    />
                    <Text
                        style={
                            this.chooseResultText(
                                this.props.navigation.state.params.status
                            ).style
                        }
                    >
                    ...
                    {this.props.navigation.state.params.status !== 'success' ? (
                        ...
                        <Button
                            ...
                            androidRippleColor={
                                this.props.userColor.card_shadow
                            }
                            onPress={() => {
                                this.props.navigation.state.params.status ===
                                'success'
