...
import { View, Text, Keyboard, Alert, Animated, Platform, KeyboardAvoidingView, NativeModules } from 'react-native'
		...
		return (
			...
			>
				<View style={styles.main_view}>
					...
					/>
					<FastImage style={styles.bottom_image} source={{ uri: ICONS.COMMON.SIGN_IN_BACKGROUND }} />
					<LinearGradient
					...
					{this.state.step === 1 ? (
						<View style={styles.form}>
							<TextField
								...
								prefix={this.prefix}
							/>
							<Text style={this.state.numberNotExists ? styles.number_exists : styles.disabled}>
						...
						<View style={styles.form}>
							...
							<Text style={styles.enter_code}>{I18n.t('ENTER_CODE_SIDN_IN')}</Text>
							<TextField
								label={''}
