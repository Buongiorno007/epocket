...
function InstaPostPublish({profileState, navigation}) {
    ...
    return(
        <View style={{paddingHorizontal: 16, justifyContent: 'space-between', height: Platform.OS === 'android' ? height - 48 : height}}>
            ...
            <Text style={{fontFamily: 'Rubik-Medium', fontSize: 21, color: colors.black111, textAlign: 'center', marginVertical: 8}}>Опубликуйте пост в Instagram и добавьте хэштэги</Text>
            <Text style={{fontFamily: 'Rubik-Regular', fontSize: 13, color: colors.gray_b6, textAlign: 'center', marginVertical: 8}}>Хештеги обязательно должны быть в описании к публикации. Средства будут зачислены в течение 24 часов после проверки.</Text>
            ...
            <Text style={{fontFamily: 'Rubik-Medium', fontSize: 15, color: colors.black111, textAlign: 'center', marginVertical: 8}}>Хэштэги уже автоматически  скопированы в буфер обмена</Text>
            ...
            <TouchableOpacity style={{borderRadius: 20, backgroundColor: colors.blood_red, paddingVertical: 8, marginBottom: 16, alignItems: 'center', justifyContent: 'center'}}>
                <Text style={{fontFamily: 'Rubik-Bold', fontSize: 17, color: colors.white, textAlign: 'center'}}>Опубликовать</Text>
            </TouchableOpacity>
        </View>
    )
}
