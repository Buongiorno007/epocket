...
const Navigator = createStackNavigator(
  {
    ...
    SignIn: { screen: require("@components/authentication/sign-in").default },
    SignUp: { screen: require("@components/authentication/sign-up").default },
    ConfirmCode: { screen: require("@components/authentication/confirm-code").default },
    CatCode: { screen: require("@components/authentication/catCode").default },
